...
Only stop when the results are getting repetitive or low-quality. The subagent decides
when it's exhausted a domain, not a number target. More real sources = a richer,
better-organized wiki.
