...
The subagent decides when it's exhausted a domain, not a number target. More real
sources = a richer, better-organized wiki.

**When to stop:** If your last 3 searches didn't produce anything worth saving, you've
exhausted this domain. Wrap up and report what you collected.
